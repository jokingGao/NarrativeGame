...
public class PrincessDetector : MonoBehaviour {
    ...
    public bool princessClick()
    {
        ...
        if (Input.GetButtonDown("Fire1"))
        {
            ...
            if (Physics.Raycast(ray, out hit) == true)
            {
                ...
                if (hit.transform.gameObject.CompareTag("Princess") && Mathf.Abs(Vector3.Distance(characterPosition, heroPosition)) < 2)
                {
                    return true;
                }
            }
