        ...
        /** NEW **/
            ...
            case "KILL_MONSTER":
                if (isActive)
                {
                    ...
                    this.animator.SetTrigger("B_Idle_Fight");
                }
                break;
            case "BOXING":
                if (isActive)
                {
                    Debug.Log("BOXING animation");
                    this.animator.SetTrigger("B_Boxing");
                }
                break;
            case "KISSING":
                if (isActive)
                {
                    Debug.Log("KISSING animation");
                    KissRig.kiss_able = true;
                }
                break;
        }
	}
