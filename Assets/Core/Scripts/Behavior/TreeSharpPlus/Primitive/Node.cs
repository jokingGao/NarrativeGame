...
// Heroyright (C) 2010-2011 ApocDev apocdev@gmail.com
// 
...
// 
// You should have received a heroy of the GNU General Public License
...
namespace TreeSharpPlus
{
    ...
    public abstract class Node : IEquatable<Node>
    {
        ...
        public virtual Node LastTicked { get { return this; } }
        ...
        protected virtual RunStatus ReturnTermination(RunStatus result)
        {
            ...
            if (this.LastTerminationStatus == null)
                // We somehow never started terminating; someone screwed up
                throw new ApplicationException(
        ...
        /// <summary>
        /// Traces where control currently exists in the node's subtree
        /// </summary>
        public IEnumerable<Node> Trace()
        {
            Node next = this;
            Node prev = null;
            while (true)
            {
                next = next.LastTicked;
                if (next == prev)
                    break;
                prev = next;
                yield return next;
